...
using Chloe;
using Chloe.MySql;
using Comic.BackOffice.ReadModel;
using Comic.Cache;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerDocument(config =>
            {
                ...
                config.DocumentName = "Comic BackOffice";
                config.Version = "1.0.0";
                config.Title = "ComicBackOfficeAPI";
            ...
            services.Scan(o => o.FromAssembliesOf(typeof(CacheProvider)).AddClasses(o => o.AssignableTo(typeof(ICache<>))).AsImplementedInterfaces().WithTransientLifetime());
            ...
            services.AddSingleton(o => CreateSerilog());
            services.AddHttpContextAccessor();
            services.AddMemoryCache();
            services.AddStackExchangeRedisCache(o =>
            {
                o.Configuration = Configuration["Connection:Redis"];
            });
        }
