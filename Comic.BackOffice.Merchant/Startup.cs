...
using Chloe;
using Chloe.MySql;
using Comic.BackOffice.Merchant.ReadModels;
using Comic.Cache;
...
namespace Comic.BackOffice.Merchant
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerDocument(config =>
            {
                ...
                config.DocumentName = "Comic BackOffice Merchant";
                config.Version = "1.0.0";
                config.Title = "ComicBackOfficeMerchantAPI";
